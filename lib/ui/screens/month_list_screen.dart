...
/// 수익 줄의 강조. 영수증 테마에는 색이 없어 잉크로 통일했다 —
/// 수익과 지출은 색이 아니라 부호(+/−)와 자리로 갈린다.
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.add_rounded, size: 16, color: AppTheme.ink(context)),
          ),
          ...
          Text('+${fmt.format(entry.amount)}원',
              style: AppTheme.sans(AppTheme.tsMD, AppTheme.ink(context), weight: FontWeight.w700)),
        ],
      ),
    );
  }
