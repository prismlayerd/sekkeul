...
///
/// 출처: 건보공단 「본인부담상한제」 2026년 표(nhis.or.kr, articleNo=10946900).
/// 국민건강보험법 시행령 별표3의 계산식(전년도 × (1+물가변동률), 1만원 버림)으로
/// 2025년 값에서 14개 전부 재현된다. 확인일 2026-09-08.
///
...
const outOfPocketCapTiers = [
  ('1분위 (하위 10% 이하)', 900000, 1430000),
  ('2~3분위', 1120000, 1810000),
  ('4~5분위', 1730000, 2450000),
  ('6~7분위', 3260000, 4040000),
  ('8분위', 4460000, 5800000),
  ('9분위', 5360000, 6980000),
  ('10분위 (상위 10% 이상)', 8430000, 10960000),
];
