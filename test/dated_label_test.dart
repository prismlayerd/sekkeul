...
void main() {
  ...
  const registry = <String, ({int reviewBy, String note})>{
    ...
    '2025년 기준 참고치': (
      reviewBy: 2026,
      note: '지자체 출산지원금 합산 추정치. 문구가 "2026년 금액은 2~3월 확정"이라 스스로 밝힌다.',
    ),
    '2024년 고시 기준': (
      reviewBy: 2026,
      note: '주거급여 기준임대료 / 신혼부부 특별공급 자산기준. 둘 다 매년 고시 — 원문 확인 필요.',
    ),
    '2023년 고시 기준': (
      reviewBy: 2026,
      note: '탄소중립포인트 적립단가. 문구가 "이후 조정 가능"이라 덧붙여 두었다.',
    ),
    '2024~2025년 기준': (
      reviewBy: 2026,
      note: '에너지바우처 가구원수별 지원액.',
    ),
    '2024년 표준': (
      reviewBy: 2026,
