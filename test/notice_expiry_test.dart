...
final notices = <Notice>[
  ...
  Notice(
    ...
    source: '지방세법 §128③ · 시행령 §125 — 화면의 1월 4.57%는 334/365 × **5%**에서 나온다. '
        'law.go.kr 조문에서 확인된 문구는 "100분의 5"이고, 민간 계산기 사이트'
        '(calculkorea.com)의 표도 같은 4.57/3.76/2.51/1.26을 쓴다 — 다만 그 사이트의 '
        '설명은 "연 3.65% 이자율"이라 자기 표와 어긋나 근거로 못 쓴다. '
        '⚠ 별도 2차 자료는 2025년 이후 3%라고 한다. 3%가 맞으면 할인을 과대 안내 중 — '
        '지방세법 시행령 §125 부칙의 연도별 경과규정을 확인해야 닫힌다',
    until: DateTime(2026, 12, 31),
    actual: 5,
    expected: 5,
    checkedOn: '2026-08-01',
