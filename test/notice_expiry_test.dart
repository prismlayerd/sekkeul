...
final notices = <Notice>[
  ...
  Notice(
    ...
    source: '보건복지부 「2025년도 본인부담상한액」 사전정보공표 '
        '(mohw.go.kr, list_no=1486195) — 일반 89/110/170/320/437/525/826만원, '
        '요양병원 120일 초과 141/178/240/396/569/684/1,074만원. '
        '요양병원 특례는 **전 구간에 있다**(하위 분위 전용이 아니다). '
        '매년 8월경 재고시.',
    until: DateTime(2026, 12, 31),
    actual: 8260000,
    expected: 8260000,
