...
final notices = <Notice>[
  ...
  Notice(
    what: '청년 주택드림 청약통장 이율(2년 이상~10년 이내, %)',
    source: '주택도시기금 상품안내 nhuf.molit.go.kr/FP/FP07/FP0701/FP07010301.jsp '
        '— 무이자 / 2.3(당첨해지 3.7) / 2.8(당첨해지 4.2) / 4.5 / 3.1. '
        '같은 표의 주택청약종합저축 열은 2.3 / 2.8 / 3.1 / 3.1이라, '
        '2년 넘긴 비교에 2.8%를 쓰면 차이가 부풀려진다. '
        '"변동금리로서 정부 고시에 의하여 변경될 수 있으며"라고 안내가 적어 두었다.',
    until: DateTime(2026, 12, 31),
    actual: 4.5,
    expected: 4.5,
    checkedOn: '2026-09-08',
  ...
  Notice(
    what: '신생아 특례 디딤돌 최저금리(%)',
    source: '주택도시기금 nhuf.molit.go.kr/FP/FP05/FP0503/FP05030801.jsp '
        '— 소득구간 x 기간(10/15/20/30년) 표의 최저 1.8%, 최고 4.5%. '
        '한도 4억(LTV 70%, 생애최초 80%), 주택 9억·85제곱미터, 순자산 5.11억, '
        '소득 1.3억(맞벌이 2억). 특례금리 5년, 추가 출산 1명당 5년 연장(최장 15년). '
        '전세는 FP05021401 — 1.3~4.3%, 한도 2.4억, 보증금 수도권 5억/그 밖 4억, '
        '순자산 3.45억, 특례 4년. 종전에 구입 1.6~3.3%/5억, 소득 2.5억으로 '
        '실제보다 후하게 적어 두었다.',
    until: DateTime(2026, 12, 31),
    actual: 1.8,
    expected: 1.8,
  ...
  Notice(
    what: '반값 모두의카드 — 수도권 일반형 일반 기준금액(원)',
    source: '국토교통부 대도시권광역교통위원회 「모두의카드」 '
        'molit.go.kr/mtc/USR/WPGE0201/m_37187/DTL.jsp '
        '— K-패스가 모두의카드로 전환. 정률제 20/30/50/53.3%, '
        '정액제 수도권 일반 6.2만(플러스 10만)·청년2자녀어르신 5.5만(9만)·'
        '3자녀저소득 4.5만(8만). 2026.4~9월 이용분은 반값 — 수도권 일반형 일반 3만원, '
        '시차시간(5:30-6:30, 9-10, 16-17, 19-20시 승차) 정률제 +30%p. '
        '월 15회 이상(가입 첫 달 예외), 이용 횟수 상한 없음 — '
        '종전에 적어 둔 "60회까지만 인정"은 원문에 없다. '
        '기후동행카드는 2026.9.1 기후동행패스로 전환되어 30일권이 끝났다.',
